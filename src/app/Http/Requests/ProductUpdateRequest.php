...
class ProductUpdateRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'picture.mimes' => 'Poza trebuie sa aiba urmatoarele extensii:jpeg,png si jpg.',
            ...
            'category_id.required' => 'Alege o categorie.',
            'category_id.integer' => 'category_id trebuie sa fie un numar intreg.',
            'category_id.exists' => 'Categoria nu exista in baza de date.',
        ];
    }
}
