<template>
    <jet-action-section>
        <template #title>
            Sesiuni în alte browsere
        </template>

        <template #description>
            Gestionați și deconectați sesiunile active pe alte browsere și dispozitive.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Dacă este necesar, puteți să vă deconectați de la toate celelalte sesiuni de browser pe toate dispozitivele. Dacă credeți că v-a fost compromis contul, ar trebui să vă actualizați și parola.
            </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                <span class="text-green-500 font-semibold" v-if="session.is_current_device">Acest dispozitiv</span>
                                <span v-else>Ultima activă {{ session.last_active }}</span>
                            </div>
                        </div>
                    </div>
                </div>
