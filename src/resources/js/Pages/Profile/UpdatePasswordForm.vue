<template>
    <jet-form-section @submitted="updatePassword">
        ...
        <template #description>
            Pentru a rămâne în siguranță asigură-te ca folosești o parola lungă și aleatorie
        </template>

        <template #form>
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="current_password" value="Parola Curentă" />
