<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-8 text-2xl">
        Bun venit in aplicatia Digital Menu.
    </div>

    <div class="mt-6 text-gray-500">
        Aplicatia Digital Menu poate creea pentru restaurantul tau un sistem de administrare pentru meniul tau ce il transforma dintr-un
        format fizic in unul digital ce va reduce  
    </div>
</div>
